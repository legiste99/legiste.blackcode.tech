...
<body>
    ...
    <section class="home home-4 d-flex align-items-center" >
                ...
                <div class="col-lg-7">
                    <div class="home-banner text-left wow customFadeInUp delay-0-2s slow">
                        ...
                        <p class="max-width-400  ml-0" >
                            An enthusiastic developer experienced in Java and PHP, I am eager to contribute to my team's success through my hard work, attention to detail, and excellent organizational skills.
                        </p>
        ...
        <div class="hero" style="background-image: url(img/bg/1.png)"></div>
            <div class="copyright">
                <div class="container">
                    <div class="row">
